...
as well as a map of those sightings. There are options for each sighting to either see the sighting location on the map or go to that specific bird's wikipedia page. 
